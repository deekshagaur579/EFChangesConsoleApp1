...
namespace EFSPConsoleApp1.Entity
{
    ...
    public partial class WorkDayEntitiesNew : DbContext
    {
        ...
        public virtual ObjectResult<get_data_Result> get_data(Nullable<bool> action)
        {
            ...
            dynamic result;
                result = ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<get_data_Result>("get_data", actionParameter);
            return result;
        }
        public virtual ObjectResult<get_data1_Result> get_data1(Nullable<bool> action)
        {
            var actionParameter = action.HasValue ?
                new ObjectParameter("action", action) :
                new ObjectParameter("action", typeof(bool));
            dynamic result;
                result = ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<get_data1_Result>("get_data1", actionParameter);
            return result;
        }
    }
}
